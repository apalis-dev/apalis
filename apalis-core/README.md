...
##### Relevant Guides:
- [**Defining Task arguments**](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/task_fn/guide/index.html) - Creating effective task arguments that are scalable and type-safe

### Backends

The [`Backend`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/backend/trait.Backend.html) trait serves as the core abstraction for all task sources.
...
- [`MemoryStorage`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/backend/memory/struct.MemoryStorage.html) : In-memory storage based on channels
- [`Pipe`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/backend/pipe/index.html) : Pipe-based backend for a stream-to-backend pipeline
- [`CustomBackend`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/backend/custom/index.html) : Flexible backend composition allowing custom functions for task management
...
The [`Worker`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/worker/index.html) is the core runtime component responsible for task polling, execution, and lifecycle management:
...
- [`Ext`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/worker/ext/index.html) - Extension traits and middleware for adding functionality to workers
...
- [**Testing task handlers with `TestWorker`**](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/worker/test_worker/index.html) - Specialized worker implementation for unit and integration testing

### Monitor

The [`Monitor`](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/monitor/struct.Monitor.html) helps manage and coordinate multiple workers:
...
Learn more about the monitor in the [`monitor` module](https://docs.rs/apalis-core/1.0.0-rc.7/apalis_core/monitor/index.html.
