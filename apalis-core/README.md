...
The [`Backend`](https://docs.rs/apalis-core/1.0.0-rc.9/apalis_core/backend/trait.Backend.html) trait serves as the core abstraction for all task sources.
...
The [`Worker`](https://docs.rs/apalis-core/1.0.0-rc.9/apalis_core/worker/index.html) is the core runtime component responsible for task polling, execution, and lifecycle management:
...
Learn more about the monitor in the [`monitor` module](https://docs.rs/apalis-core/1.0.0-rc.9/apalis_core/monitor/index.html.
