...
- **Simple and predictable task handling** - [Task handlers](https://docs.rs/apalis-core/1.0.0-rc.4/apalis_core/task_fn/guide/index.html) are just async functions with a macro-free API
...
# apalis-redis = { version = "1.0.0-rc.4" } # Use redis/sqlite/postgres etc
```
