...
type SteppedService<Compact, Conn, IdType> =
    BoxedService<Task<Compact, Conn, IdType>, GoTo<StepResult<Compact, IdType>>>;

type DagService<Compact, Conn, IdType> = BoxedService<Task<Compact, Conn, IdType>, Compact>;
