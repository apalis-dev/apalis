...
impl<A: Adapter + Unpin, Args: Unpin> Sink<Task<Value, RandomId>> for FileStorage<Args, A> {
    ...
    fn start_send(self: Pin<&mut Self>, item: Task<Value, RandomId>) -> Result<(), Self::Error> {
