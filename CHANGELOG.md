...
- deps(deps): bump sentry-tower from 0.48.5 to 0.49.2 ([#781](https://github.com/apalis-dev/apalis/pull/781))
...
- **api**: standardize `Backend` by adding `BackendConfig` and `WireFormatBackend` ([#772](https://github.com/apalis-dev/apalis/pull/772))
